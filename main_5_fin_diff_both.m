...
for h = h_vec    
    ...
    gradf_const_handle = @(x) findiff_grad_5(x, h, 'c');
    ...
    for n = dims
        ...
        for x0 = start_points
            ...
            % MODIFIED
            tic
            [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf_const_handle,Hessf_const_handle,kmax,tolgrad,c1, rho, btmax, beta, jmax_M);
            time_M = toc;
    
            % TRUNCATED
            tic
            [xk_T,fk_T,gradfk_norm_vec_T,k_T,xseq_T, btseq_T, flag_multi_T, err_seq_T] = truncated_newton_bcktrck(x0,f,gradf_const_handle,Hessf_const_handle,kmax,tolgrad,c1, rho, btmax, jmax_T, eta);
            time_T = toc;
    ...
    gradf_var_handle = @(x) findiff_grad_5(x, h* max(abs(x), 1e-12), 'c');
    ...
    for n = dims
        ...
        for x0 = start_points
            ...
            % MODIFIED
            tic
            [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf_var_handle,Hessf_var_handle,kmax,tolgrad,c1, rho, btmax, beta, jmax_M);
            time_M = toc;
    
            % TRUNCATED
            tic
            [xk_T,fk_T,gradfk_norm_vec_T,k_T,xseq_T, btseq_T, flag_multi_T, err_seq_T] = truncated_newton_bcktrck(x0,f,gradf_var_handle,Hessf_var_handle,kmax,tolgrad,c1, rho, btmax, jmax_T, eta);
            time_T = toc;
