    ...
    for n = dims
        ...
        for x0 = start_points
            if n == 1e5
                 % MODIFIED
                tic
                [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf,Hessf_const_handle,kmax_special,tolgrad_special,c1, rho, btmax, beta, jmax_M);
                time_M = toc;
                ...
                % MODIFIED
                tic
                [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf,Hessf_const_handle,kmax,tolgrad,c1, rho, btmax, beta, jmax_M);
                time_M = toc;

                % TRUNCATED
                tic
                [xk_T,fk_T,gradfk_norm_vec_T,k_T,xseq_T, btseq_T, flag_multi_T, err_seq_T] = truncated_newton_bcktrck(x0,f,gradf,Hessf_const_handle,kmax,tolgrad,c1, rho, btmax, jmax_T, eta);
                time_T = toc;
            end
            ...
            fprintf('  Modified  | Pt %d | Grad norm: %.2e | Iters: %d/%d | Flag: %d | Rate: %.2f | Time: %.4fs\n', ...
                num, gradfk_norm_vec_M(end), k_M, kmax, flag_multi_M, rate_exp_M, time_M);

            % TRUNCATED
            fprintf('  Truncated | Pt %d | Grad norm: %.2e | Iters: %d/%d | Flag: %d | Rate: %.2f | Time: %.4fs\n\n', ...
                    num, gradfk_norm_vec_T(end), k_T, kmax, flag_multi_T, rate_exp_T, time_T);
    ...
    for n = dims
        ...
        for x0 = start_points
            ...
            if n == 1e5
                ...
                % MODIFIED
                tic
                [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf,Hessf_var_handle,kmax_special,tolgrad_special,c1, rho, btmax, beta, jmax_M);
                time_M = toc;
                ...
                % MODIFIED
                tic
                [xk_M,fk_M,gradfk_norm_vec_M,k_M,xseq_M, btseq_M, flag_multi_M, err_seq_M] = modified_newton_bcktrck(x0,f,gradf,Hessf_var_handle,kmax,tolgrad,c1, rho, btmax, beta, jmax_M);
                time_M = toc;
        
                % TRUNCATED
                tic
                [xk_T,fk_T,gradfk_norm_vec_T,k_T,xseq_T, btseq_T, flag_multi_T, err_seq_T] = truncated_newton_bcktrck(x0,f,gradf,Hessf_var_handle,kmax,tolgrad,c1, rho, btmax, jmax_T, eta);
                time_T = toc;
